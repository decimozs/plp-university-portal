Public Class StudentLoginForm
    Public studentID As New TextBox
    ...
    Private Sub StudentIdTextBox()
        studentID = Tools.CreateTextBox(Me, "Enter your student id", 450, 38, 590, 488)
    End Sub
    ...
    Private Sub LoginButton()
        ...
        AddHandler loginBtn.Click, Sub(sender As Object, e As EventArgs)
                                       Handlers.StudentLoginAccess(studentID.Text, password.Text)
                                       Handlers.CreateStudentResources(studentID.Text)
                                   End Sub
    End Sub
    ...
    Public Sub ResetTextBox()
        studentID.Text = "Enter your student id"
