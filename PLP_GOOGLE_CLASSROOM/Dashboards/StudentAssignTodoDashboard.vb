Public Class StudentAssignTodoDashboard
    Dim availableTodoPanel As New FlowLayoutPanel
    Protected Overloads Overrides ReadOnly Property CreateParams() As CreateParams
        ...
        End Get
    End Property
    Private Sub StudentAssignTodoDashboard_Load(sender As Object, e As EventArgs) Handles MyBase.Load
