Public Class TeacherCalendarDashboard
    Public parseId = Handlers.IdParser(TeacherLoginForm.teacherId.Text)
    Public calendarPanel As New FlowLayoutPanel
    Protected Overloads Overrides ReadOnly Property CreateParams() As CreateParams
        ...
        End Get
    End Property
    Private Sub TeacherCalendarDashboard_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub CreateCalendarClass()
        Dim assignedTasks As List(Of Calendar) = FetchAssignTask(parseId)
