...
Public Class AnnouncementDashboard
    ...
    Public announcementPanel As New FlowLayoutPanel
    Protected Overloads Overrides ReadOnly Property CreateParams() As CreateParams
        ...
        End Get
    End Property
    Private Sub AnnouncementDashboard_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    End Sub
    Private Sub CreateAnnouncementButton()
        Dim button As Label = Tools.CreateButton(Me, 66, 66, 1556, 670)
        AddHandler button.Click, Sub(sender As Object, e As EventArgs)
                                     TeacherDashboard.createAnnouncementPanelPopup.Visible = True
                                     TeacherDashboard.createAnnouncementPanelPopup.BringToFront()
                                 End Sub
    End Sub
End Class
