Public Class DiscussionForumDashboard
    Public parseId = Handlers.IdParser(TeacherLoginForm.teacherId.Text)
    Public discussionPanel As New FlowLayoutPanel
    Protected Overloads Overrides ReadOnly Property CreateParams() As CreateParams
        ...
        End Get
    End Property
    Private Sub DiscussionForumDashboard_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    End Sub
    Private Sub CreateDiscussionButton()
        Dim button As Label = Tools.CreateButton(Me, 66, 66, 1556, 670)
        AddHandler button.Click, Sub(sender As Object, e As EventArgs)
                                     TeacherDashboard.createDiscussionForumPanelPopup.Visible = True
                                     TeacherDashboard.createDiscussionForumPanelPopup.BringToFront()
                                 End Sub
    End Sub
End Class
